...
const TypeRatingRequirements = ({ Requirements }) => {
  return (
    <section
      className="w-full py-16 px-4 mt-6 bg-cover bg-center relative rounded-2xl font-onest"
      style={{
        backgroundImage: `url(${bgImage.src})`,
      }}
    >
      <p className="text-white text-center m-4 text-[24px] md:text-[50px] lg:text-[64px] font-bold">
        Pilot 360 Requirements
      </p>
      <div className="max-w-[90%] mx-auto grid gap-8 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-5">
...
export default TypeRatingRequirements;
